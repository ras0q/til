...
export class matIV {
  ...
  scale(mat: number[], vec: Float64Array, dest: Float32Array) {
    dest[0] = mat[0] * vec[0];
    dest[1] = mat[1] * vec[0];
    dest[2] = mat[2] * vec[0];
    dest[3] = mat[3] * vec[0];
  ...
  translate(mat: number[], vec: number[], dest: Float32Array) {
  ...
  transpose(mat: number[], dest: Float32Array) {
  ...
  inverse(mat: number[], dest: Float32Array) {
